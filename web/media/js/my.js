    ...
    render(){
        return (
            <Griddle results={this.props.r} columnMetadata={columnMeta} rowMetadata={rowMeta} tableClassName="table"
                     showFilter={false} showSettings={false} resultsPerPage={10} bodyHeight={'500'}
    ...
    render() {
        return (
            <table width="100%">
                <tr>
                    <td>
                        <BabyNames data={this.props.data} filter={this.state.filterText} name={this.state.filterName}/>
                    </td>
                    <td class="test">
